...
public interface ChannelHandler {
     ...
     *
     *
     * 正常情况下同一个 ChannelHandler 的不同的实例会被添加到不同的 Channel 管理的 pipeline 里面的，
     * 但是如果你需要全局统计一些信息，比如所有连接报错次数（exceptionCaught）等，
     * 这时候你可能需要使用单例的ChannelHandler，
     * 需要注意的是这时候ChannelHandler上需要添加@Sharable注解。
     *
     */
    @Inherited
    @Documented
